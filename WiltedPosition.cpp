...
class Position : public Bitboards{
    public:
        ...
        */
        ...
        int material[6] = {0, 918, 459, 310, 270, 107};
        */

        /* Tuning 2
        int mps[6][64] = 
        {{4, 20, 0, 30, 22, 8, 16, 6, 
        -22, -29, 11, -1, 39, 22, 9, -30, 
        -35, -14, -21, -37, 5, -5, 22, -5, 
        36, -5, 29, 5, -21, -8, -7, 25, 
        -41, 18, 13, 32, -36, -21, -18, -4, 
        -5, 0, -4, -11, -6, -5, -23, -4, 
        -15, 37, 4, -10, -15, -19, 16, 41, 
        -26, -3, 16, 0, 9, -14, 41, -24},

        {-73, -24, 47, -61, 32, 67, -40, -36, 
        -83, -30, 10, 5, -83, -4, -39, 59, 
        39, -41, -15, 25, -15, -35, -81, 84, 
        38, 70, 39, -61, 63, -53, -40, 73, 
        42, -20, -53, 45, 0, -79, 48, -66, 
        10, 11, 48, -28, 79, 30, 1, -14, 
        24, 50, 38, 36, -54, -11, 33, -25, 
        12, -55, 37, 40, 37, -45, 31, 26},

        {-36, -13, 32, -3, -4, 18, 31, -29, 
        5, -34, 45, -22, 37, 2, -5, -26, 
        -14, 20, 6, 40, 37, 41, -30, 22, 
        33, 3, 37, 24, 34, -19, 28, 30, 
        2, 19, 13, -34, 13, 0, 38, 0, 
        -27, -37, -27, -8, 30, 18, -9, -5, 
        -13, -13, -37, 1, -13, -26, -20, -13, 
        -8, 5, -19, 11, 15, -1, -10, -8},

        {-9, -32, 16, 26, -18, -30, -24, 21, 
        8, 11, -26, -30, 8, -32, 14, 10, 
        -20, -1, -25, 4, 25, -10, 18, 1, 
        10, -16, 8, -18, 13, -11, 7, 0, 
        8, 26, 18, -6, 9, 14, -10, 12, 
        8, 11, 19, 8, 1, 21, -23, -5, 
        -3, 11, 2, 7, 16, -31, 8, -6, 
        -29, 8, -2, -17, -6, -24, -9, 7},

        {14, 18, 7, -8, 23, 16, -6, 12, 
        -10, 19, 17, 22, -8, 26, 22, 16, 
        -6, 31, -17, -5, 7, -2, 23, 10, 
        0, 30, 22, 39, 42, -1, 26, 9, 
        8, -18, 3, 16, 12, 38, 7, 5, 
        -19, 9, 10, 20, -13, 12, -4, 3, 
        -2, -6, 0, -8, 13, 19, -4, -6, 
        -11, -21, 0, -17, -9, -26, -18, 5},

        {0, 0, 0, 0, 0, 0, 0, 0, 
        11, 3, 0, -3, 7, -2, 2, -1, 
        5, 10, 7, 14, 5, 12, -5, 5, 
        -14, -13, -19, 1, -17, -15, -9, -31, 
        -26, -32, -17, -16, -7, -15, -15, -31, 
        -22, -27, -18, -28, -10, -29, 11, -21, 
        -33, -31, -25, -31, -20, -15, 10, -22, 
        0, 0, 0, 0, 0, 0, 0, 0}};

        int eps[6][64] = 
        {{22, 5, -31, -15, 24, 22, 24, 6, 
        -30, -8, -18, -16, -35, 20, 11, -11, 
        23, 21, 22, -10, -4, 26, 10, 19, 
        -32, -16, 5, -9, -22, -9, 21, -3, 
        17, 8, -16, 2, 6, -1, 28, -20, 
        1, -11, -4, -3, 23, 7, 4, -29, 
        5, -4, -2, -24, 5, 1, 5, -15, 
        -28, -8, -30, -39, -20, -6, -15, 0},

        {-73, -66, 57, -39, 8, -50, 19, -34, 
        -39, 1, -73, 34, 90, 76, 31, -18, 
        -23, 64, 69, 4, 2, 57, 7, -21, 
        9, -43, -9, 0, 65, -74, 57, -39, 
        -64, -62, 22, -26, -19, 45, -81, -51, 
        55, 70, 6, -19, -71, 77, 58, 25, 
        -13, -50, 12, 15, 36, 72, 41, 43, 
        11, 13, -58, -74, -16, 34, -27, -13},

        {-16, 19, 32, -33, 6, 30, -6, -28, 
        -2, 45, 32, -32, 13, 24, 13, 42, 
        -2, 42, 14, 15, 14, -2, -19, 12, 
        3, -14, 8, -6, 28, 21, 31, 18, 
        9, -18, -28, -17, 16, -16, -27, 15, 
        15, -36, -15, 7, -28, -45, -12, 5, 
        5, 26, 22, -34, 35, -36, 29, -15, 
        -7, -17, 26, 0, -10, 13, 17, -12},

        {12, -27, 22, 17, 9, 22, 23, -26, 
        11, 10, -3, 25, 8, 0, -24, -16, 
        0, -20, -12, 22, -6, -25, -23, -3, 
        0, 30, -27, 34, 25, -12, -20, 21, 
        -1, 1, 17, -8, -4, -12, -1, -20, 
        -24, 0, 18, 22, 0, -11, 25, 10, 
        1, -9, -9, -26, -11, 6, 13, 9, 
        -18, -3, -34, -27, 6, -31, 9, -15},

        {13, 2, -15, -1, 1, 7, 19, -1, 
        18, -15, 18, 22, 24, 7, 0, 7, 
        -15, -23, -16, 27, 0, 24, 23, 22, 
        -10, 3, -6, 14, 0, 3, 22, 11, 
        -1, 0, 7, 6, 21, 18, 11, -6, 
        14, -9, 3, -15, 22, 21, -6, -18, 
        -20, -22, -5, 15, 9, 4, -21, -4, 
        -7, -23, -8, -16, -23, -13, -31, 6},

        {0, 0, 0, 0, 0, 0, 0, 0, 
        28, 21, 21, 12, 7, 9, 12, 21, 
        34, 35, 26, 20, 14, 20, 16, 37, 
        40, 20, 12, 3, 2, 23, 23, 22, 
        16, 10, -12, -12, -6, -6, 2, 6, 
        3, 7, -9, -4, -6, 2, -5, -3, 
        3, -9, 0, -9, -17, 10, -2, -3, 
        0, 0, 0, 0, 0, 0, 0, 0}};

        int material[6] = {0, 929, 464, 310, 277, 113}; 
        */
        ...
        int material[6] = {0, 929, 476, 318, 284, 117};
        */

        //Tuning 4
        int mps[6][64] = 
        {{3, 18, 0, 28, 20, 7, 16, 5, 
        -21, -28, 11, 0, 39, 20, 9, -29, 
        -35, -13, -21, -35, 5, -5, 22, -5, 
        36, -3, 29, 5, -18, -6, -5, 24, 
        -41, 17, 13, 32, -34, -18, -20, -5, 
        0, 2, -2, -9, -4, -3, -22, -1, 
        -16, 30, 12, -7, -9, -12, 9, 29, 
        -26, 0, 17, -7, 6, -29, 40, -23},

        {-72, -22, 45, -59, 32, 68, -40, -33, 
        -78, -26, 13, 5, -82, -4, -36, 62, 
        36, -39, -13, 25, -13, -30, -74, 75, 
        32, 66, 40, -51, 57, -43, -31, 59, 
        33, -16, -44, 46, 6, -64, 50, -63, 
        25, 4, 39, -11, 63, 23, 6, -13, 
        20, 50, 26, 24, -34, -13, 17, -25, 
        9, -56, 30, 28, 34, -45, 29, 22},

        {-31, -10, 32, 2, -1, 17, 30, -26, 
        9, -27, 45, -10, 40, 4, -3, -28, 
        -9, 22, 13, 44, 37, 43, -29, 16, 
        30, 7, 38, 28, 28, -16, 21, 23, 
        3, 23, 19, -26, 8, 2, 34, -6, 
        -24, -31, -22, -11, 21, 18, -7, -13, 
        -24, -12, -37, 0, -20, -23, -20, -26, 
        -5, 3, -11, 12, 17, 4, -22, -31},

        {-9, -31, 15, 22, -18, -29, -24, 22, 
        5, 10, -23, -30, 8, -32, 13, 8, 
        -18, -1, -22, 7, 26, -6, 16, 6, 
        4, -10, 13, -6, 18, -6, 6, -2, 
        13, 19, 14, 2, 14, 20, -5, 9, 
        0, 16, 4, 10, 1, 23, -20, -2, 
        0, 0, 1, -3, 10, -30, 21, -2, 
        -30, 6, -22, -15, -15, -23, -1, 7},

        {13, 17, 6, -8, 23, 15, -6, 11, 
        -11, 18, 15, 24, -7, 26, 20, 12, 
        -7, 36, -10, 4, 6, 0, 21, 9, 
        1, 19, 39, 49, 53, 6, 18, 12, 
        -1, -13, 12, 16, 20, 33, 8, 1, 
        -25, 5, 0, 28, -3, 18, 1, -5, 
        -3, 14, -1, -2, 0, 14, -2, -8, 
        1, -41, -3, -20, -13, -25, -13, -2},

        {0, 0, 0, 0, 0, 0, 0, 0, 
        23, 13, 6, 4, 11, -1, 1, 1, 
        18, 13, 10, 28, 13, 6, -1, 13, 
        -25, -24, -15, -2, -11, -25, -20, -38, 
        -26, -23, -25, -14, -10, -26, -25, -37, 
        -31, -21, -32, -36, -18, -26, 7, -33, 
        -36, -32, -37, -46, -25, -7, 20, -44, 
        0, 0, 0, 0, 0, 0, 0, 0}};

        int eps[6][64] = 
        {{16, 4, -31, -15, 17, 21, 25, 5, 
        -30, -6, -16, -17, -33, 18, 12, -9, 
        24, 26, 22, -9, -4, 28, 14, 18, 
        -30, -11, 8, -4, -13, -1, 20, -3, 
        20, 11, -12, 2, 12, 6, 8, -19, 
        14, -7, -3, 0, 13, 2, 1, -23, 
        3, -1, 3, -20, 3, 1, -5, -26, 
        -27, -7, -27, -41, -24, -12, -36, -6},

        {-72, -64, 55, -37, 9, -49, 19, -33, 
        -37, 3, -69, 35, 89, 74, 30, -16, 
        -23, 64, 69, 4, 2, 59, 9, -23, 
        6, -42, -7, 4, 62, -69, 59, -40, 
        -65, -60, 24, -24, -16, 50, -79, -49, 
        63, 64, 5, -14, -69, 67, 58, 25, 
        -13, -50, 3, 12, 39, 69, 33, 42, 
        9, 11, -59, -76, -15, 32, -27, -13},

        {-7, 23, 32, -23, 9, 29, -5, -22, 
        8, 44, 30, -14, 17, 25, 17, 38, 
        5, 26, 20, 17, 13, 0, -17, 6, 
        5, -4, 13, -1, 19, 20, 18, 7, 
        6, -12, -18, -8, 9, -12, -29, 9, 
        14, -28, -7, 6, -26, -43, -12, 2, 
        2, 20, 21, -31, 22, -34, 27, -19, 
        -15, -19, 16, 0, -14, -4, 15, -18},

        {12, -24, 19, 13, 9, 20, 22, -26, 
        7, 8, 1, 22, 8, 0, -23, -17, 
        0, -17, -8, 18, -4, -18, -23, -2, 
        -3, 30, -22, 35, 18, -9, -19, 20, 
        -1, 0, 16, 0, -1, -5, 0, -20, 
        -23, 0, 10, 24, 1, -7, 20, 13, 
        0, -18, -10, -24, -2, 6, 0, 8, 
        -21, -4, -42, -24, 0, -28, 14, -11},

        {12, 1, -15, 0, 0, 5, 18, -2, 
        16, -15, 18, 24, 21, 6, -1, 5, 
        -16, -18, -9, 28, 0, 23, 18, 20, 
        -7, 4, 2, 16, 6, 6, 16, 8, 
        -1, 2, 15, 11, 19, 12, 8, -10, 
        6, -9, -3, -11, 24, 11, -5, -19, 
        -19, -20, -2, 10, 3, -5, -20, -4, 
        0, -29, -9, -18, -25, -13, -26, 0},

        {0, 0, 0, 0, 0, 0, 0, 0, 
        53, 41, 37, 29, 14, 14, 17, 29, 
        59, 46, 33, 35, 21, 21, 25, 45, 
        42, 28, 8, -1, -5, 10, 23, 15, 
        9, 11, -7, -17, -18, -12, 3, -7, 
        10, 4, -9, -12, -10, -4, -12, -14, 
        3, 6, -4, 0, -15, -3, -14, -10, 
        0, 0, 0, 0, 0, 0, 0, 0}};

        int material[6] = {0, 937, 474, 312, 280, 118};
